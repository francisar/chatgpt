...
import (
	...
	"github.com/francisar/chatgpt/public/doc"
...
func (m *Microservice) Register(ctx context.Context) error {
	pb.RegisterFrancisarChatgptServer(m.server.Server(), m)

	// 注册服务信息
	mux, err := m.baseCfg.Register(ctx, pb.RegisterFrancisarChatgptHandlerFromEndpoint)
	if err != nil {
		return err
	}
